...
## 🛠 Features
- **Real-time Translation:** Automatically generates subtitles in real-time for any video.
- **Multilingual Support:** Supports various languages, making videos accessible to a global audience.
- **Speech Recognition:** Uses advanced speech recognition to ensure high accuracy in subtitles.
- **User-Friendly Interface:** Simple and intuitive design for easy use.

## 🌐 How to Use the Extension
1. **Open a Video:** Navigate to any video online, like on YouTube or Vimeo.
2. **Activate the Extension:** Click on the videoTranslatorExtenstion icon in your Chrome toolbar.
3. **Select Language:** Choose your preferred language for subtitles.
4. **Enjoy the Video:** Watch the video with real-time translated subtitles.

## ⚡ Troubleshooting
If you encounter any issues:
- **Check Internet:** Ensure you have a stable internet connection.
- **Browser Update:** Make sure you are using the latest version of Google Chrome.
- **Reload the Video:** Sometimes, reloading the video helps in resetting the subtitle settings.

## 🌍 Community Support
Join our community for support, feedback, and feature requests. You can reach out through the issues section on our GitHub page or engage with other users in discussions. Your input helps us improve the extension!
